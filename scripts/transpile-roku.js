 ...
 *       → Logger(moduleName) factory function returning BRS AA with info/warn/error/debug subs
 * In BrightScript, `m` inside an AA method refers to the AA itself (the receiver),
 * so m.module correctly accesses the `module` key set at construction.
 */
